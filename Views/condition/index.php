<main class="conditionG">
    <h1>Conditions Générales de Vente et d'Utilisation</h1>
    <h2>1 - Champ d'application</h2>
    <p>
        Les présentes conditions s’appliquent à toutes les utilisations du Site spacepixelarcade par des personnes physiques ou morales, majeures et/ou juridiquement capables.
        Ce document s’applique, sans restriction ni réserve à toutes les ventes conclues entre les Parties en France et à l’étranger. Aucune condition particulière ne peut, sauf exception formelle écrite et signée par le Client et le Vendeur prévaloir contre les présentes Conditions Générales de Vente et d'Utilisation. Si l’une des clauses des présentes conditions générales de vente se trouvait nulle ou annulée, les autres clauses n’en seraient pas pour autant annulées.
        Toute utilisation du Site implique que l’Utilisateur ait pris connaissance des conditions générales et qu’il adhère à ces mêmes conditions. Préalablement à la validation de toute commande, l’Utilisateur devra reconnaitre avoir pris connaissance des Conditions Générales de Vente et d’Utilisation (CGVU) et les accepter. A cette fin, aucune signature manuscrite ne sera requise. En tout état de cause, les CGVU sont accessibles à tout moment depuis le Site. Le Vendeur se réserve la possibilité de procéder à des modifications de ces dernières de sorte à les adapter aux modalités de vente et de fonctionnement du Site et d'un Produit.
    </p>
    <h2>2 - Lexique</h2>
    <p>
        Client : Toute personne physique ou morale qui bénéficie d’un compte personnel sur le Site.
        Site : Désignation de la plateforme de vente spacepixelarcade.
        Vendeur : Professionnel, fournisseur de produits ou de prestations destinés à la vente sur le Site.
    ...
    <h2>3 - Identification du Vendeur et du Site</h2>
    <p>
        La micro entreprise pixelspacearcade est domiciliée à Blv de pac man 44600 Saint-Nazaire.
        Le Vendeur est joignable :
        Par e-mail à l’adresse suivante : contact@spacepixelarcade.com
        Par téléphone au : +33 02 44 ** ** 45
        Par courrier à l’adresse suivante : Blv de pac man 44600 Saint-Nazaire
        Le Site internet spacepixelarcade est édité par pixelspacearcade et est hébergé par O2switch.
    </p>
    <h2>4 - Objet</h2>
    <p>
        Le Vendeur exerce une activité de Vente de produit rétro gaming.
    ...
    <h2>7 - Dispositions relatives aux Produits et aux Commandes</h2>
    <h3>7.1 - Les Produits</h3>
    <p>Les Produits sont ceux qui figurent sur la liste ou le catalogue du Vendeur ou ceux proposés par ce dernier au Client en fonction de sa demande et de ses besoins.</p>
    <h3>7.2 - Achats et commandes</h3>
    <p>
        Tout achat ou commande d’un ou de plusieurs Produit(s) par un Client
        peut faire l’objet d’un devis personnalisé et sur demande
        .
    ...
    <h2>8 - Droit et délai de rétractation</h2>
    <p>Du fait de la spécificité des Produits vendus par le Vendeur et en application des dispositions de l’article L221-28 du Code de la consommation, le droit de rétractation n’est pas applicable.</p>
    ...
    <p>La responsabilité du Vendeur ne pourra pas être mise en œuvre si la non-exécution ou le retard dans l’exécution de l’une de ses obligations décrites dans les présentes conditions générales de vente découle d’un cas de force majeure au sens de l’article 1218 du Code civil.</p>
    ...
    <h2>14 - Les utilisateurs</h2>
    <p>Tout Utilisateur s’engage à faire un usage approprié du Site, à fournir des informatiques véridiques sur sa structure, ses coordonnées et sur toutes les informations communiquées à l’occasion de sa demande d’inscription.</p>
    <h2>15 - Les Clients</h2>
    <p>Chaque Client s’engage à maintenir ses données à jour à chaque fois qu’il sera amené à les utiliser sur le Site. Il s’engage également à ne pas commettre d’activités illicites ou illégales, à ne pas diffuser de contenus, ni propagandes contraires aux bonnes mœurs, à la bonne foi et à l’ordre public.</p>
    <h2>16 - Modalités d'inscription</h2>
    <p>
        Chaque Utilisateur devra renseigner les informations sollicitées par le Site pour toute création de compte à savoir :
        - Nom
        - Prénom
        - Adresse email
        - Numéro de téléphone
        L’Utilisateur créera un mot de passe personnel et unique à cette occasion. Le Client devra accepter les présentes conditions générales de vente et d’utilisation, téléchargeables à tout moment. Dès validation de la création du compte, un e-mail de confirmation sera adressé sur l’adresse communiquée à cette occasion.
    </p>
    <h2>16 - Processus de commande</h2>
    <p>
        Toute commande est préalablement soumise à la création d’un compte personnel ou d’une connexion à celui existant, le cas échéant. Le Client disposera de toutes les informations relatives aux Produits, leur description, et leur référence, et ce, avant toute validation de commande. Le processus de commandes est le suivant :
        ...
        - A l’issue de la sélection et avant toute validation de commande, le Client a accès a son panier et au récapitulatif des Produits souhaité(s), au montant unitaire de chaque article, aux frais éventuels de livraison et au montant total. Il dispose de la possibilité d’ajouter ou de supprimer des articles.
    ...
    <p>
        Entre
        La Micro Entreprise pixelspacearcade, située Blv de pac man 44600 Saint-Nazaire,
    ...
    <h2>1 - Objet</h2>
    <p>
        Le Présent Contrat a pour objet de définir les conditions et modalités de production, de vente et de livraison des Produits du Vendeur à destination du Client.
    ...
    <h2>2 - Modalités de commandes</h2>
    <p>
        Toute demande peut être effectuée par le Client :
        - Par le site internet
    ...
    <h2>3 - Tarifs et modalités de règlement</h2>
    <p>
        En contrepartie du ou des Produit(s), objet du Présent Contrat, le Client sera redevable de la somme de [MONTANT] € HT soit [MONTANT] € TTC. Ladite somme devra être réglée à réception de la facture.
    ...
    <p>
        ...
        Le Présent Contrat est conclu pour une durée déterminée, il débutera à la signature du Contrat et prendra fin à l’issue de la Vente convenue entre les Parties.
    </p>
    <h2>5 - Droits, obligations et engagements des Parties</h2>
    <p>
    ...
    <h2>6 - Propriété intellectuelle et droits d’exploitation</h2>
    <p>
    ...
    <h2>7 - Rupture du contrat</h2>
    <p>
        La résiliation du contrat ne peut, en principe, intervenir avant la fin de la vente réalisée par le vendeur sauf en cas d’un commun accord express des Parties. Tout manquement de l’une des parties à ses obligations peut entrainer, si bon semble au créancier de l’obligation inexécutée, la résiliation de plein droit du présent contrat. La résiliation interviendra suite à l’envoi d’une mise en demeure du créancier adressée par lettre recommandée avec accusé de réception demeurée sans effet, sans préjudice de tous dommages et intérêts.
    ...
    <h2>8 - Droit et Juridiction applicable</h2>
    <p>Le Présent Contrat est soumis au Droit français et relève de la compétence des juridictions françaises.</p>
    Fait à : Saint-Nazaire
    Fait le : Mercredit 19 juillet 2023
    Signature du Vendeur : THOMAS
    Signature du Client :
</main>